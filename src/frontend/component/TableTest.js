...
class TableTest extends Component {
  ...
  render() {
    ...
    const sortedData = this.getSortedData();
    return (
        <Table multiSelectable onChange={this.handleChange} onRowSelect={this.handleRowSelect} style={{marginTop: 10, width: "100%"}}>
          <TableHead>
            <TooltipCell
                tooltip="The total amount of food energy in the given serving size">
              Dessert (100g serving)
            </TooltipCell>
            <TableCell onClick={this.handleSortClick} numeric
                       sorted={sorted}>Calories</TableCell>
